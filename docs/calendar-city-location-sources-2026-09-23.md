...
同日从同一份 2026 California Census places 原文件核对两座新增活动城市；均为城市示意点：

| 城市 | GEOID | 原始纬度 | 原始经度 | 保存坐标 |
| --- | --- | --- | --- | --- |
| San Mateo | 0668252 | 37.56031 | -122.3106 | 37.560, -122.311 |
| Sonoma | 0672646 | 38.290331 | -122.459831 | 38.290, -122.460 |

以下为最初日历发布时的检查记录，之后新增活动由完整目录覆盖测试验证：
