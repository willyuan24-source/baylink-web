...
const cssHook = registerHooks({ load(url, context, nextLoad) {
  if (url.endsWith('/tools.css') || url.endsWith('/loan-calculator.css') || url.endsWith('/unit-price.css') || url.endsWith('/dining-calculator.css')) return { format: 'module', shortCircuit: true, source: 'export {};' };
