...
export const BAY_CITIES: BayCity[] = [
  ...
  city('daly-city', '戴利城', 'Daly City', 'peninsula', [-122.4688, 37.6879], 'peninsula:daly-city-bart', '雾气里的半岛门户', 'A fog-kissed gateway to the Peninsula.'),
  city('south-san-francisco', '南旧金山', 'South San Francisco', 'peninsula', [-122.4077, 37.6547], 'peninsula:orange-memorial', '雕塑花园与社区公园的日常', 'Sculpture gardens and everyday park life.'),
  city('san-bruno', '圣布鲁诺', 'San Bruno', 'peninsula', [-122.4111, 37.6305], 'peninsula:san-bruno-park', '山脚小城与机场旁的日常', 'A foothill city beside the airport corridor.'),
  city('millbrae', '密尔布瑞', 'Millbrae', 'peninsula', [-122.3872, 37.6009], 'peninsula:millbrae-transit', '半岛旅途中的一站', 'A Peninsula stop along the way.'),
  city('sfo-airport', 'SFO 机场区', 'SFO Airport', 'peninsula', [-122.392414, 37.615998], 'peninsula:sfo-airport', 'San Mateo County 的航空门户', 'An air gateway in unincorporated San Mateo County.', 'area'),
  ...
  city('belmont', '贝尔蒙特', 'Belmont', 'peninsula', [-122.2758, 37.5202], 'peninsula:twin-pines', '半岛山丘之间的小城', 'A small city among the Peninsula hills.'),
  ...
  city('menlo-park', '门洛帕克', 'Menlo Park', 'peninsula', [-122.1817, 37.453], 'peninsula:burgess-park', '树荫下的半岛邻里', 'Peninsula neighbourhoods beneath the trees.'),
  ...
  city('sunnyvale', '桑尼维尔', 'Sunnyvale', 'south-bay', [-122.0363, 37.3688], 'south-bay:sunnyvale-heritage', '果园记忆与市中心街道', 'Orchard memories and downtown streets.'),
  ...
  city('santa-clara', '圣克拉拉', 'Santa Clara', 'south-bay', [-121.9552, 37.3541], 'south-bay:santa-clara-university', '红瓦校园与城市公园', 'Red-tile campus courtyards and city parkland.'),
  ...
  city('milpitas', '苗必达', 'Milpitas', 'south-bay', [-121.9, 37.4323], 'south-bay:milpitas-bart', '连接南湾与东湾的旅途', 'A stop between the South Bay and East Bay.'),
  ...
  city('hayward', '海沃德', 'Hayward', 'east-bay', [-122.0808, 37.6688], 'east-bay:hayward-garden', '庭园与东湾市中心散步', 'A garden pause and an East Bay downtown walk.'),
  city('fremont', '弗里蒙特', 'Fremont', 'east-bay', [-121.9886, 37.5483], 'east-bay:fremont-central-park', '湖岸、历史农场与山脊远景', 'Lakeshore paths, historic farmland and ridgeline views.'),
];
