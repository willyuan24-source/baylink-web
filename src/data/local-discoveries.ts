...
export const currentOpenings = [...septemberOpenings, ...additionalOctoberOpenings].sort((a, b) => Number(b.status === 'open') - Number(a.status === 'open') || b.verifiedAt.localeCompare(a.verifiedAt) || (b.openedOn || '').localeCompare(a.openedOn || '') || a.name.localeCompare(b.name));
