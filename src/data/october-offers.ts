...
export const newOctoberOffers: FreebieOffer[] = [
  {
    ...
    imageKey: '', sourceUrl: 'https://bampfa.org/event/free-first-thursdays', sourceLabel: 'BAMPFA 免费首个周四日历', storeUrl: 'https://bampfa.org/visit/hours',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://sjmusart.org/programs-at-sjma/first-fridays', sourceLabel: 'SJMA 首个周五免费入馆规则',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://computerhistory.org/plan-your-visit/discounts/', sourceLabel: 'CHM 持卡免费入场限制', storeUrl: 'https://about.bankofamerica.com/en/making-an-impact/museums-on-us-partners',
  },
  {
  ...
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://about.asianart.org/ticketing/', sourceLabel: '亚洲艺术博物馆免费日票务',
  },
  {
  ...
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://gggp.org/visit/admissions-hours/', sourceLabel: '植物园免费日与十月入园时间',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://www.lowes.com/events/register/firefighting-plane', sourceLabel: '消防飞机官方日期与预约', storeUrl: 'https://www.lowes.com/diy-projects-and-ideas/workshops',
  },
  {
  ...
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://svma.org/visit/', sourceLabel: 'Sonoma 美术馆免费周三与闭馆公告',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://gggp.org/tickets/', sourceLabel: '日本茶园官方免费入园时间',
  },
  {
  ...
  },
  {
    ...
    imageKey: 'library', sourceUrl: 'https://smcl.org/faq/museum-passes-discover-go/', sourceLabel: 'SMCL 门票资格与预约 FAQ', storeUrl: 'https://smcl.org/blogs/post/explore-today-with-discover-go/',
  },
  {
    ...
    imageKey: 'library', sourceUrl: 'https://aclibrary.org/faqs/', sourceLabel: 'AC Library Discover & Go 资格',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://parks.santaclaracounty.gov/library-parks-pass', sourceLabel: 'Santa Clara 县图书馆公园通行证', storeUrl: 'https://parks.santaclaracounty.gov/library-parks-pass/faq',
  },
];
