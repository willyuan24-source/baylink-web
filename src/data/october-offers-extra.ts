...
export const additionalOctoberOffers: VerifiedExtraOffer[] = [
  {
    ...
    imageKey: '', sourceUrl: 'https://museumsc.org/events/', sourceLabel: 'Sonoma County Museum 十月官方日历',
  ...
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://www.sfmoma.org/free-days/', sourceLabel: 'SFMOMA 免费家庭日与成人名额', verifiedAt: '2026-09-15',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://museum.stanford.edu/visit', sourceLabel: 'Cantor 官方免费入馆与现行开放时间', verifiedAt: '2026-09-15',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://sfpl.org/releases/2026/07/15/free-radon-detector-loan-program-promote-home-safety',
  ...
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://www.berkeleypubliclibrary.org/locations/tool-lending-library/borrowing-tools',
  ...
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://www.ikea.com/us/en/stores/emeryville/', sourceLabel: 'IKEA Emeryville As-is 周三条款', verifiedAt: '2026-09-15',
  },
  {
    ...
    imageKey: '', sourceUrl: 'https://www.poppyandclaro.com/', sourceLabel: 'Poppy & Claro 秋季 Doggie Dinners', verifiedAt: '2026-09-15',
  },
];
